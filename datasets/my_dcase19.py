...
def my_dcase19(name, transform=None):
    """
...
class DCASE19(ContinualDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = my_dcase19(self.NAME, transform=transform)
        memory_dataset = my_dcase19(self.NAME, transform=test_transform)
    ...
    def not_aug_dataloader(self, batch_size):
        ...
        train_dataset = my_dcase19(self.NAME, train=True, transform=transform)
